// src/selftests/effects_selftests.cpp
// PRD-SPLIT-MAIN-3 Phase 3-B: audio mixer / VFX / pro / motion graphics /
// hardware perf / pro extensions selftests moved verbatim from src/main.cpp.
