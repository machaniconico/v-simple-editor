...
QString prepareAudioMix(Timeline *timeline, const QString &outputPath,
...
struct Options {
    ...
    double fps = 30.0;
    // Selftests retain the intermediate beneath outputDir for failed-gate diagnosis.
    bool retainAudioMixForDiagnostics = false;
